...
export const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  return (
    <div
      className={cn(
        'rounded-xl overflow-hidden border border-white/[0.08] bg-surface-0 text-xs font-mono shadow-md flex flex-col',
        className
      )}
    >
      {/* Header with Title and Copy button */}
      <div className="flex items-center justify-between px-3 py-1.5 bg-surface-1 border-b border-white/[0.06] flex-shrink-0 select-none">
      ...
      {/* Code body */}
      <div
        className="p-3 overflow-auto text-zinc-200 leading-relaxed font-mono selection:bg-primary/30 selection:text-white"
        style={{ maxHeight }}
      >
        {lines.map((line, idx) => (
