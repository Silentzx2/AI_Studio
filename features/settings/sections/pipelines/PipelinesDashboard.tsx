...
const MODEL_LIBRARY: Record<string, ModelReference> = {
  ...
  triposg: {
    label: 'TripoSG',
    summary: 'Generative 3D model creation from images with geometry focus.',
    diskSpaceMb: 6144,
    quality: 4,
  ...
  unirig: {
    label: 'UniRig',
    summary: 'Universal rigging system for automatic skeleton generation across diverse 3D characters.',
    diskSpaceMb: 2048,
    quality: 4,
    recommendation: 'balanced',
