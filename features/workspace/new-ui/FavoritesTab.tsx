    ...
    <div className="flex-1 min-h-0 p-8 flex flex-col gap-8 animate-fadeIn text-[hsl(var(--foreground))] overflow-y-auto" id="favorites-tab-panel">
      ...
      <div className="flex flex-col gap-2 max-w-4xl">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[hsl(var(--surface-2))] border border-[hsl(var(--border)/0.3)] flex items-center justify-center">
            <Heart size={20} className="text-[hsl(var(--muted-foreground))]" />
          </div>
          <div>
            <h2 className="text-lg font-semibold text-[hsl(var(--foreground))] tracking-tight">Favorite Creations</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5" id="favorites-grid">
        {favoriteItems.map((item) => (
          ...
          >
            {/* Visual Box */}
            <div className="relative aspect-square w-full rounded-xl bg-[hsl(var(--surface-2))] border border-[hsl(var(--border)/0.2)] overflow-hidden flex items-center justify-center">
              <div className="w-16 h-16 rounded bg-[hsl(var(--surface-1))] border border-[hsl(var(--border)/0.3)] flex items-center justify-center">
        ...
        {favoriteItems.length === 0 && (
          <div className="col-span-full bg-[hsl(var(--surface-1))] border border-dashed border-[hsl(var(--border)/0.2)] rounded-2xl p-12 text-center flex flex-col items-center justify-center text-[hsl(var(--muted-foreground))]" id="favorites-empty-placeholder">
            <Heart size={40} className="text-[hsl(var(--border))] mb-3" />
            <p className="text-xs font-medium text-[hsl(var(--foreground))]">No favorites saved yet</p>
